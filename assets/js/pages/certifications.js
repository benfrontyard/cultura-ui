...
const GUIDELINES_HTML = `
  <ul class="small text-ch-secondary mb-0 ps-3">
    ...
    <li class="mb-2">Use the <strong>Classic</strong> style direction for publisher and product placement unless a branded accent or seal-first variant is approved.</li>
    <li class="mb-2">Do not alter badge text, colors, hexagon seal, tier labels, or the verifier line ("Verified by Culture Hive").</li>
